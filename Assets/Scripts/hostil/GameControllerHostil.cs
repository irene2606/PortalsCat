...
public class GameControllerHostil : MonoBehaviour
{
    ...
    public bool jugadorEncontróGato;

    public GameObject panelPausa; // Referencia al panel de pausa

    private bool juegoPausado = false;

    public SlimeEnemyController slimeMovement;
    ...
    private void Update()
    {
        if (!juegoIniciado)
        {
            ...
            if (playerMovement != null && slimeMovement!= null && portalInteract!= null)
            {
                playerMovement.enabled = true;
                slimeMovement.enabled = true;
                portalInteract.enabled=true;
                
            }*/

            // Esperar a que el jugador pulse "E" para iniciar
    ...
    public void PausarJuego()
    {
        ...
        // Desactivar el movimiento del jugador y enemigos
        if (playerMovement != null && slimeMovement!= null)
        {
    ...
    public void HaMuerto(bool estado){
        muerto=estado;
    }

    public void JugadorEncontroGato()
    {
        jugadorEncontróGato = true;
    }
    ...
    public void FinDelJuego(bool victoria)
    {
        ...
        if (victoria)
        {
            ...
            int nivelActual = SceneManager.GetActiveScene().buildIndex - 6;
            PlayerPrefsManager.GuardarNivelDesbloqueadoHostil(nivelActual + 1);
        }else if(muerto && !victoria){
